...
export default function ReviewCard({ review }: { review: reviewItem }) {
  ...
  return (
    <div
      data-cy='reviewCard'
      className='w-full h-44 shadow-[7px_7px_12px_#EFEFEF,-7px_-7px_12px_#F7F7F7] rounded-xl bg-white text-[#343434] flex justify-center'>
      <div className='flex flex-col w-[90%] m-8'>
        ...
        {review.comment ? (
          <p data-cy='cardText' className='block text-start'>
            {review.comment}
          </p>
        ) : (
